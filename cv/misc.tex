...
\entry*[2026]  \textbf{Distinguished Reviewer Award} for the ``ACM Student Research Competition Track`` at ICSE 2026
...
\entry*[2025 -- $\cdots$] Software Engineering at Montreal -- Meeting at UdeM -- Organizer
\entry*[2024 -- $\cdots$] International workshop on collaborative and participatory modeling (MODELS co-located workshop) -- Co-organizer
\subrubric{Reviews for Journals}
\entry*[2026 -- $\cdots$] IEEE Transactions on Software Engineering
...
\entry*[2026 -- $\cdots$] International Conference on Software Engineering (ICSE) -- ACM Student Research Competition
...
\subrubric{Other Certification}
\entry*[2021] \textbf{Basic Teaching Certificate - COURSE ZBL 7} -- Awarded by Johannes Kepler University Linz.
